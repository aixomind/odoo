...
export class L4eInventoryDashboard extends Component {
    static template = "l4e_dashboard_collection_19.InventoryDashboard";
    ...
    getCompanyCurrency() {
        const currencyId = this.state.data?.currency_id || (user && user.activeCompany && user.activeCompany.currency_id);
...
registry.category("actions").add("l4e_dashboard_collection_19.inventory_dashboard", L4eInventoryDashboard);
