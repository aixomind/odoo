...
class SaleOrder(models.Model):
    ...
    def _onchange_margin_auto_percent(self):
        for line in self.order_line:
            if line.cost_price:
                ...
                line.margin_percent = self.margin_auto_percent / 100
                line.margin_value = line.cost_price * line.margin_percent
                line.price_unit = line.cost_price + line.margin_value

    @api.onchange('margin_auto_value')
    def _onchange_margin_auto_value(self):
        for line in self.order_line:
            if line.cost_price:
                line.margin_percent = 0  # clear percent so Path 2 runs
                line.margin_value = self.margin_auto_value
                line.price_unit = line.cost_price + line.margin_value
                line.margin_percent = line.margin_value / line.cost_price
    ...
    def _creation_message(self):
        """ Override the default creation message for Chatter to show 'Quotation created'
