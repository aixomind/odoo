...
# Company lock dates that block a plain miscellaneous entry. Odoo 19 has
...
class InventoryBackdateWizard(models.TransientModel):
    ...
    new_time = fields.Float(
        ...
        help="Time of day, in your own timezone, stamped on the stock move.")
    ...
    def action_apply(self):
        self.ensure_one()
        if not self.env.user.has_group('l4e_stock_inventory_backdate.group_inventory_backdate'):
