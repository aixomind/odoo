...
export class L4eInventoryDashboard extends Component {
    static template = "l4e_dashboard_collection_18.InventoryDashboard";
...
registry.category("actions").add("l4e_dashboard_collection_18.inventory_dashboard", L4eInventoryDashboard);
