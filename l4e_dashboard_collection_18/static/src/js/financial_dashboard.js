...
export class FinancialDashboard extends Component {
    static template = "l4e_dashboard_collection_18.FinancialDashboard";
...
registry.category("actions").add("l4e_dashboard_collection_18.financial_dashboard", FinancialDashboard);
